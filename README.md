...
Cada edificio tiene un objetivo mínimo de generación semanal: el edificio A debe generar al menos 1000 kWh por semana y el edificio B al menos 800 kWh, comparando siempre la suma de los cinco días de la semana. Si la producción semanal es menor al objetivo, el sistema mostrará el mensaje: “Producción inferior al objetivo semanal. Se recomienda realizar una revisión.” En caso de que se cumpla devuelve True, en caso de que no se cumpla devuelve False y en caso de no cumplir para la comparación se devuelve None y el sistema mostrara el mensaje: “Semana incompleta, no se puede verificar.”
...
El sistema calculará el día con mayor y menor generación de una semana, la semana con mayor generación de cada edificio (de forma independiente, sin sumar ambos edificios) y el edificio con mayor generación semanal, indicando siempre dónde ocurrió. Para comparar la generación entre el Edificio A y el Edificio B, o para determinar cuál de los dos generó más o menos, se utilizarán siempre períodos equivalentes y completos, es decir, las mismas semanas y sin semanas incompletas en ninguno de los dos edificios. Si no existiera ninguna semana completa y equivalente entre ambos edificios, el sistema informará explícitamente que no hay datos suficientes para la comparación, en lugar de mostrar un resultado de 0 kWh que podría confundirse con una generación real nula. Si existieran empates (por ejemplo, dos días, dos semanas o ambos edificios con el mismo valor máximo o mínimo), el sistema informará todos los valores empatados en lugar de asumir un único resultado. Por ejemplo: “Máxima generación: 310 kWh – Edificio A – Semana 2 – Miércoles”.
